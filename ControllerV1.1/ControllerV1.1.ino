...
#define half_value 2047

float X = TWOPI/max_value;
int i = 0;
int y = 0;
int t = 0;
// =========================================================
...
void setup() {
    ...
    pinMode(PWM1, OUTPUT);
    pinMode(PWM2, OUTPUT);
    analogWriteFrequency(PWM1,freq); 
    analogWriteResolution(PWM1,resolution); 
    analogWriteFrequency(PWM2,freq); 
    analogWriteResolution(PWM2,resolution); 
    Serial.begin(115200);
